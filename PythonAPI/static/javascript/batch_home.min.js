            ...
            <form id="GiveScoreForm${d.assessmentId}" class="needs-validation" novalidate autocomplete="off">
                <div id="scoreFormElem${d.assessmentId}">
                    <div class="form-group">
                        ...
                        <input placeholder="Please type a score out of 100%" type="number" step="0.01" min="0.01" max="100" class="form-control-range" id="score${d.assessmentId}" name="score${d.assessmentId}" required>
